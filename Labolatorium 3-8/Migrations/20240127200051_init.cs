        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCarrierId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Products_ShippingCarriers_ShippingCarrierId",
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Description", "Manufacturer", "Name", "Price", "ProductionDate", "ShippingCarrierId", "SupplierId" },
                values: new object[,]
                {
                    { 1, "Description 1", "Manufacturer 1", "Product 1", 100m, new DateTime(2024, 1, 27, 21, 0, 50, 861, DateTimeKind.Local).AddTicks(6608), 1, 1 },
                    { 2, "Description 2", "Manufacturer 2", "Product 2", 200m, new DateTime(2024, 1, 27, 21, 0, 50, 861, DateTimeKind.Local).AddTicks(6648), 2, 2 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ShippingCarrierId",
                table: "Products",
